        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" action="{{route('log')}}" method="POST">
                @csrf
                ...
                <button type="submit" class="btn  d-grid w-100 btn-primary" style="background-color:#419535">Login </button>
              </form>
